            ...
            <section class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3>
                      Add info
                    <a class="btn btn-success btn-sm float-right" href="{{route('infos.view')}}"><i class="fa fa-angle-double-down"></i> view info</a>  
                  </h3>
                </div><!-- /.card-header -->
                <div class="card-body">
                    <form id="updateForm" action="{{route('infos.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
